...
Report bugs at https://github.com/nephila/aldryn-apphooks-config/issues.
...
Ready to contribute? Here's how to set up `aldryn-apphooks-config` for local development.

1. Fork the `aldryn-apphooks-config` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/aldryn-apphooks-config.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv aldryn-apphooks-config
    $ cd aldryn-apphooks-config/
